...
<head>
    ...
    <title>Asset Request {{ ucfirst($status) }} - Barangay e-Governance</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="content">
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $customRequestId }}</span>
                </div>
                @endif
                <div class="info-row">
                    <span class="info-label">Status</span>
                    <span class="info-value status-value">{{ ucfirst($status) }}</span>
                </div>
                @if($requestDate)
                <div class="info-row">
            ...
            <div class="request-id-section">
                ...
                <div class="request-id-value">{{ $customRequestId }}</div>
            </div>
            @endif
            ...
            <div class="info-box">
                ...
                <p>Your asset request has been approved. You can now proceed to claim your rented assets at the barangay office. Please bring a valid ID for verification.</p>
            </div>
            ...
            <div class="info-box">
                ...
                <p>If you have any questions about this decision or wish to reapply, please contact our office. Our team is here to assist you.</p>
            </div>
            @else
            <!-- Pending Info -->
            <div class="warning-box">
                ...
                <p>Your asset request is currently under review. We will notify you once your request has been processed. Please wait for further updates.</p>
            </div>
            @endif
