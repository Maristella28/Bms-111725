    ...
    <div class="email-wrapper">
        ...
        <div class="header">
            <div class="header-content">
                ...
                <h1>Welcome to Barangay e-Governance</h1>
                <p class="header-subtitle">Complete Your Registration with Verification Code</p>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="welcome-banner">
                ...
                <div class="welcome-banner-content">
                    <p>Thank you for registering with Barangay e-Governance! To complete your registration, please enter the 6-digit verification code below in your registration form.</p>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">Return to the registration page</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Step 2</span>
                    <span class="info-value">Enter the 6-digit code above</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Step 3</span>
                    <span class="info-value">Complete your registration</span>
                </div>
            </div>
            ...
            <div class="warning-box">
                ...
                <p>This verification code will expire in <strong>5 minutes</strong>. If you don't enter the code in time, you can request a new one through the registration page.</p>
            </div>
            
            <!-- Security Notice -->
            <div class="security-box">
                <strong>🔒 Security Notice</strong>
                <p>Never share this code with anyone. Barangay e-Governance will never ask for this code via phone or email. If you receive any suspicious requests, please contact our support team immediately.</p>
            </div>
            ...
            <p class="description-text">
                If you didn't request this verification code, please ignore this email. Your account will not be created without completing the verification process.
            </p>
            ...
            <div class="contact-info">
                <p>
                    ...
                    If you have any questions or need help with the registration process, please contact the barangay office. 
