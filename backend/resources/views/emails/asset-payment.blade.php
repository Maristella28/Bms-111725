...
<head>
    ...
    <title>Asset Payment Receipt - Barangay e-Governance</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="email-wrapper">
        ...
        <div class="header">
            <div class="header-content">
                ...
                <p class="header-subtitle">Your Asset Rental Payment Has Been Successfully Received</p>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="success-banner">
                ...
                <div class="success-banner-content">
                    <p>Your asset rental payment has been processed successfully. Thank you for your payment!</p>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value amount-value">₱{{ number_format($amount, 2) }}</span>
                </div>
            ...
            <div class="receipt-section">
                <div class="receipt-label">Your Receipt Number</div>
                <div class="receipt-value">{{ $receiptNumber }}</div>
            </div>
            ...
            <div class="asset-items">
                ...
                <div class="asset-item">
                    <div>
                        ...
                        <div class="asset-item-details">Quantity: {{ $item['quantity'] }}</div>
                        @endif
                        @if(isset($item['request_date']))
                        <div class="asset-item-details">Request Date: {{ $item['request_date'] }}</div>
                        @endif
                    </div>
                </div>
                @endforeach
            ...
            <p class="description-text">
                Your payment has been successfully processed and recorded. Please keep this receipt for your records. 
                You can view your payment history and asset rental requests through your account dashboard.
            </p>
            
            <!-- Call to Action Button -->
            <div class="btn-container">
                <a href="{{ $actionUrl }}" class="btn">View My Asset Requests</a>
            </div>
            ...
            <div class="contact-info">
                <p>
                    ...
                    If you have any questions about this payment or your asset rental, please don't hesitate to contact the barangay office. 
