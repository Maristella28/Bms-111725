...
<head>
    ...
    <title>Updated Payout Schedule - Barangay e-Governance</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-wrapper">
        ...
        <div class="header">
            <div class="header-content">
                <div class="logo-container">
                    ...
                    @else
                        <div style="width: 90px; height: 90px; border-radius: 50%; background: white; display: inline-block; text-align: center; line-height: 90px; border: 4px solid rgba(255,255,255,0.3); font-size: 28px; font-weight: 700; color: #3b82f6; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.15);">BM</div>
                    @endif
                </div>
                <h1>Payout Schedule Updated</h1>
                <p class="header-subtitle">Important Schedule Change Notification</p>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="greeting">
                Hello <strong>{{ $beneficiaryName }}</strong>,
            </div>
            ...
            <div class="info-banner">
                ...
                <div class="info-banner-content">
                    <p>Please be informed that the payout schedule for the program <strong>"{{ $programName }}"</strong> has been updated.</p>
                </div>
            </div>
            ...
            <!-- New Payout Date Section -->
            <div class="payout-date-section">
                <div class="payout-date-label">New Payout Date & Time</div>
                <div class="payout-date-value">{{ $newPayoutDate }}</div>
            </div>
            ...
            <div class="warning-box">
                ...
                <p>Please arrive on time for the payout. Late arrivals may not be accommodated due to scheduling constraints. We recommend arriving 15 minutes early to ensure a smooth process.</p>
            </div>

            <!-- Additional Information -->
            <div class="info-box">
                <strong>📝 Please Note</strong>
                <p>We apologize for any inconvenience this schedule change may cause. Please make sure to mark this new date and time on your calendar and set a reminder to avoid missing the payout.</p>
            </div>
            ...
            <p class="description-text">
                ...
                Our team is here to assist you and ensure you receive your benefits on time.
            </p>
            ...
            <div class="contact-info">
                <p>
                    ...
                    If you have any questions or need further assistance regarding this payout schedule change, please contact the barangay office. 
