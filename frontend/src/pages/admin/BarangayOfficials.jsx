...
const BarangayOfficials = () => {
  ...
  const [officialsCount, setOfficialsCount] = React.useState(0);
  const [staffsCount, setStaffsCount] = React.useState(0);

  React.useEffect(() => {
    // Fetch officials
    axiosInstance.get('/organizational-chart/officials')
      .then(res => setOfficialsCount(res.data.length))
      .catch(() => setOfficialsCount(0));
    // Fetch staff
    axiosInstance.get('/organizational-chart/staff')
      .then(res => setStaffsCount(res.data.length))
      .catch(() => setStaffsCount(0));
  }, []);

  const handleOfficialsClick = () => {
    navigate('/admin/officials-management');
  };

  const handleStaffsClick = () => {
    navigate('/admin/staff-managements');
  };
        ...
        <div className="w-full max-w-7xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto leading-relaxed">
              Comprehensive management system for barangay officials and staff members with detailed profiles and administrative functions.
            </p>
          </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-2xl font-bold text-gray-800">{officialsCount}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-2xl font-bold text-gray-800">{staffsCount}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-center justify-center">
          ...
          >
            ...
            <div className="relative p-8 text-center">
              ...
              <p className="text-base text-gray-600 mb-6 leading-relaxed">
                View and manage barangay officials including captains, councilors, and committee heads
              </p>
              
              {/* Action Button */}
              <div className="flex items-center justify-center space-x-2 text-green-600 font-semibold text-base group-hover:text-green-700 transition-colors duration-300">
          ...
          >
            ...
            <div className="relative p-8 text-center">
              ...
              {/* Description */}
              <p className="text-base text-gray-600 mb-6 leading-relaxed">
                Access staff information, roles, and administrative functions for barangay personnel
              </p>
              
              {/* Action Button */}
              <div className="flex items-center justify-center space-x-2 text-blue-600 font-semibold text-base group-hover:text-blue-700 transition-colors duration-300">
